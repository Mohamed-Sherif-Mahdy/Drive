...
namespace Drive.Service
{
  public class FileHandlerService : IFileHandlerService
  {
    ...
    {
      if (!Exists(fileName, currentUser)) return "You do NOT have this file..";
      ...
      string url = "https://www.dwsamplefiles.com/?dl_id=176";

      string filePath = Path.Combine(Directory.GetCurrentDirectory(), "Downloads", Name, fileName);
      //File.Create(Path.Combine(Directory.GetCurrentDirectory(), "Downloads", Name, fileName));
